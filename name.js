...
let selectDiv = document.querySelector("#namesContainer");
for (const values of names) {
  let buttonElement = document.createElement("button");
  buttonElement.innerText = values.name;
  if (values.gender === "boy") {
    buttonElement.classList.add("boy");
  } else {
    buttonElement.classList.add("girl");
  }
  selectDiv.append(buttonElement);
  buttonElement.style.margin = "1rem";
  buttonElement.style.padding = "1rem";
  buttonElement.style.borderRadius = "1rem";
}
